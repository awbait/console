  ...
  theme: {
    extend: {
      colors: {
        ...
        skeleton: c("skeleton"), // заливка заглушки на время загрузки
        // всплывающий слой: подсказки, меню, поповеры. На шаг выше карточки,
        // иначе в тёмной теме попап сливается с ней (тень на чёрном не видна).
        overlay: c("overlay"),
        "overlay-edge": c("overlay-edge"), // его рамка, светлее рамки карточки
