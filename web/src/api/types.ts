...
export interface RequestEvent {
  ...
  // Extra detail the status columns cannot carry, shaped per event type: why a
  // change could not be applied (merge_blocked, change_withdrawn), and the
  // fields two changes disagreed on.
