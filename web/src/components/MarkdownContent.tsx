...
// MarkdownContent renders GitHub-flavoured markdown (README, changelog lines,
// …) with our Tailwind styles. Pass `inline` for single-line snippets.
//
// Nobody imports this directly: the parser behind it is a large dependency for
// something most screens never show, so it is reached through Markdown.tsx,
// which loads this file only when there is markdown to draw.
